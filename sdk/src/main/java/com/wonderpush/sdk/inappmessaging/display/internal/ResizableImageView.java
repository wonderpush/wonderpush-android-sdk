...
public class ResizableImageView extends AppCompatImageView {
  ...
  private void checkMinDim() {
    int minWidth = Math.max(MeasureUtils.getMinimumWidth(this, 0), getSuggestedMinimumWidth());
    int minHeight = Math.max(MeasureUtils.getMinimumHeight(this, 0), getSuggestedMinimumHeight());
  ...
  private Dimensions bound(int targetW, int targetH) {
    int maxWidth = MeasureUtils.getMaxWidth(this, Integer.MAX_VALUE);
    int maxHeight = MeasureUtils.getMaxHeight(this, Integer.MAX_VALUE);
